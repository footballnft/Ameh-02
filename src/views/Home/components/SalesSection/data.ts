...
export const swapSectionData = (t: TranslateFunction): SalesSectionProps => ({
  headingText: t('Buy Crypto. Trade anytime. No registration, no hassle.'),
  bodyText: t('Buy and trade any token on Binance Smart Chain in seconds, just by connecting your wallet.'),
  reverse: false,
  primaryButton: {
    to: '/Buy',
    text: t('Buy Now'),
